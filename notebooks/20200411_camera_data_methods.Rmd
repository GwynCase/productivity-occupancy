...
We calculated the relative proportions of avian and mammalian biomass delivered to the nests during the study period.

For each nest, we calculated the mean prey deliveries per day by count and by biomass.
<!-- Is it clear that this is the average of an average? -->
